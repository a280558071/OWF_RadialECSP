...
Coord_OS = xlsread('HKY_WT.xlsx','B44:C44'); % Option2: Put the substation node in the centre
...
Max_Range= norm([3 4]);% define a max range to limit the number of candidate lines
I=[];
J=[];
len_l=[];
